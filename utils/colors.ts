...
export const PRIMARY_GREEN = '#58d68d'
export const PRIMARY_ERROR = '#CD001A'
export const PRIMARY_GRAY = '#3c3c3c'
export const LIGHT_GRAY = '#F0F3F3'
export const DARK_GRAY = '#413d43'
